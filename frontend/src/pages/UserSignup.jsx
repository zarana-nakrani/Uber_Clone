...
const UserSignup = () => {
  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-between">
      ...
      <div>
        <p className='text-xs leading-tight'>By proceeding, you consent to get calls, Whatsapp or SMS messages, including by automated means, from Uber and its affliates to the number provided </p>
      </div>
    </div>
  )
}
